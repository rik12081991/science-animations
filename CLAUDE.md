...
Open items: free-running CuSO4 inert with replenish off leaves the cathode idle instead of switching to H2 (flagged, not fixed). Not yet tested on a real iPad. GitHub Pages is live (student links: `https://rik12081991.github.io/science-animations/dist/<topic>-student.html`); 2026-09-21 commits not yet pushed. Next topic: refraction (`docs/WAVES-PLAN.md` §2). Future topics mentioned: diffusion, rates, states of matter.
