...
(function () {
  ...
  function create(ctx) {
    ...
    // 1 cm graph paper, anchored on the mirror and the object base line so the object and its image sit on the same squares
    function drawGrid(d, s, L) {
      ...
      const ax = L.kind === 'single' ? L.hit[0] : L.mx, ay = L.kind === 'single' ? L.hit[1] : L.baseY;
